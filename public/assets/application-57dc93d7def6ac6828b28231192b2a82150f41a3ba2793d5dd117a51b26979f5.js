...
(function() { this.JST || (this.JST = {}); this.JST["templates/answer"] = (function() {
    ...
    return function(context) {
      ...
      return Skim.withContext.call({}, context, function() {
        var _buf, _skim_codeattributes1, a, i, len, ref;
        _buf = '';
        _buf += "\u003cdiv class=\"answer\"\u003e\u003ch2\u003eNew Answer\u003c/h2\u003e\u003cdiv id=\"answer-id-";
        _buf += this.escape(this.answer.id);
        _buf += "\"\u003e\u003cp\u003e";
        _buf += this.escape(this.answer.body);
        _buf += "\u003c/p\u003e";
        if (this.attachments.length > 0) {
          _buf += "\u003cdiv id=\"attachments\"\u003e\u003cul\u003e";
          ref = this.attachments;
          for (i = 0, len = ref.length; i < len; i++) {
            a = ref[i];
            _buf += "\u003cli\u003e\u003ca";
            _skim_codeattributes1 = a.url;
            ...
            _buf += "\u003e";
            _buf += this.escape(a.name);
            _buf += "\u003c/a\u003e\u003c/li\u003e";
          }
          _buf += "\u003c/ul\u003e\u003c/div\u003e";
        }
        _buf += "\u003cdiv class=\"vote\" data-id=\"";
        _buf += this.escape(this.answer.id);
        _buf += "\"\u003e";
        if (gon.is_user_signed_in && gon.user_id !== this.answer.user_id) {
          _buf += "\u003cform action=\"/answers/";
          _buf += this.escape(this.answer.id);
          _buf += "/vote_down\" class=\"button_to\" data-remote=\"true\" id=\"vote-down-btn\" method=\"post\"\u003e\u003cinput name=\"commit\" type=\"submit\" value=\"-\" /\u003e\u003c/form\u003e\u003cdiv class=\"vote_score\"\u003e0\u003c/div\u003e\u003cform action=\"/answers/";
          _buf += this.escape(this.answer.id);
          _buf += "/vote_up\" class=\"button_to\" data-remote=\"true\" id=\"vote-up-btn\" method=\"post\"\u003e\u003cinput name=\"commit\" type=\"submit\" value=\"+\" /\u003e\u003c/form\u003e\u003cform action=\"/answers/";
          _buf += this.escape(this.answer.id);
          _buf += "/vote_reset\" class=\"button_to btn_hide\" data-remote=\"true\" id=\"vote-reset-btn\" method=\"post\"\u003e\u003cinput name=\"commit\" type=\"submit\" value=\"reset\" /\u003e\u003c/form\u003e";
        } else {
          _buf += "\u003cdiv class=\"vote_score\"\u003e0\u003c/div\u003e";
        }
        _buf += "\u003c/div\u003e\u003cdiv class=\"comment\"\u003e";
        if (gon.is_user_signed_in) {
          _buf += "\u003cdiv class=\"comment_form\"\u003e\u003cp\u003e\u003cform accept-charset=\"UTF-8\" action=\"/answers/";
          _buf += this.escape(this.answer.id);
          _buf += "/comment\" class=\"new_comment\" data-remote=\"true\" id=\"new_comment\" method=\"post\"\u003e\u003cinput name=\"utf8\" type=\"hidden\" value=\"✓\" /\u003e\u003cinput name=\"_method\" type=\"hidden\" value=\"post\" /\u003e\u003cdiv class=\"form-group\"\u003e\u003clabel for=\"comment_body\"\u003e\u003c/label\u003e\u003ctextarea class=\"form-control\" id=\"comment_body\" name=\"comment[body]\"\u003e\u003c/textarea\u003e\u003c/div\u003e\u003cinput name=\"commit\" type=\"submit\" value=\"Add comment\" /\u003e\u003c/form\u003e\u003c/p\u003e\u003c/div\u003e";
        }
        _buf += "\u003c/div\u003e\u003c/div\u003e\u003c/div\u003e";
        return _buf;
      });
