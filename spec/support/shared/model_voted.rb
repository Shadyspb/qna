shared_examples_for "model_voted" do
  ...
  describe '#vote_up' do
    it 'add a new positive vote' do
      expect(assosiation.votes).to include(assosiation.vote_up(user))
    end

    it 'check assosiation new positive vote with user' do
      expect(user.votes).to include(assosiation.vote_up(user))
    end
  ...
  describe '#vote_down' do
    it 'add a new negative vote' do
      expect(assosiation.votes).to include(assosiation.vote_up(user))
    end

    it 'check assosiation new negative vote with user' do
      expect(user.votes).to include(assosiation.vote_down(user))
    end
