...
RSpec.describe AnswersController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'with no valid attributes' do
      ...
      it 'render create template' do
        post :create, params: { question_id: question, format: :js, answer: attributes_for(:invalid_answer) }
        expect(response).to render_template 'create'
      end
    end
  end
  ...
  describe 'DELETE #destroy' do
    ...
    context'user is not author' do
      it 'deletes answer' do
        expect { delete :destroy, params: {question_id: question, id: answer, format: :js} }.to change(Answer, :count)
      end
    end
  end
end
